        ...
        for (let i = 0; i < events.length; i += 1) {
            for (let j = 0; j < this.length; j += 1) {
                ...
                if (!targetSelector) {
                    ...
                    for (let k$1 = 0; k$1 < el.dom7LiveListeners.length; k$1 += 1) {
                        if (listener) {
...
function eq(index) {
  ...
  var closest = this; // eslint-disable-line
    ...
    function find(selector) {
        ...
        for (let i = 0; i < this.length; i += 1) {
            const found = this$1[i].querySelectorAll(selector);
  ...
  var children = []; // eslint-disable-line
        for (let i = 0; i < this.length; i += 1) {
            const childNodes = this$1[i].childNodes;
    ...
    var Utils = {
        ...
        extend: function extend() {
            let args = [], len$1 = arguments.length;
    ...
    const Support = (function Support() {
        return {
            touch: win.Modernizr && win.Modernizr.touch === true || (function checkTouch() {
                return Boolean('ontouchstart' in win || win.DocumentTouch && document instanceof win.DocumentTouch);
            })(),
    ...
    const staticAccessors = {components: {}};
    ...
    SwiperClass.installModule = function installModule(module) {
        let params = [], len = arguments.length - 1;
    ...
    SwiperClass.use = function use(module) {
        ...
        return Class.installModule(...[module].concat(params));
    };
    ...
    const updateAutoHeight = function () {
        const swiper = this;
        const activeSlides = [];
        let newHeight = 0;
        let i;
    ...
    const updateSlidesOffset = function () {
        const swiper = this;
    ...
    const updateSlidesProgress = function (translate) {
        if (translate === void 0) {
    ...
    const updateProgress = function (translate) {
        if (translate === void 0) {
            translate = this.translate || 0;
        }
    ...
    const updateSlidesClasses = function () {
        const swiper = this;
    ...
    const updateActiveIndex = function (newActiveIndex) {
        const swiper = this;
    ...
    const updateClickedSlide = function (e) {
        const swiper = this;
        const params = swiper.params;
    ...
    const getTranslate = function (axis) {
        if (axis === void 0) {
    ...
    const setTranslate = function (translate, byController) {
        const swiper = this;
        const rtl = swiper.rtl;
        const params = swiper.params;
        const $wrapperEl = swiper.$wrapperEl;
    ...
    const minTranslate = function () {
        return -this.snapGrid[0];
    };

    const maxTranslate = function () {
    ...
    const setTransition = function (duration, byController) {
        const swiper = this;
    ...
    const transitionStart = function (runCallbacks) {
    ...
    const transitionEnd$1 = function (runCallbacks) {
        if (runCallbacks === void 0) {
            runCallbacks = true;
        }
    ...
    const slideTo = function (index, speed, runCallbacks, internal) {
        if (index === void 0) {
            index = 0;
        }
        if (speed === void 0) {
    ...
    const slideNext = function (speed, runCallbacks, internal) {
        if (speed === void 0) {
            speed = this.params.speed;
        }
        if (runCallbacks === void 0) {
    ...
    /* eslint no-unused-vars: "off" */
    const slidePrev = function (speed, runCallbacks, internal) {
        if (speed === void 0) {
            speed = this.params.speed;
        }
        if (runCallbacks === void 0) {
    ...
    /* eslint no-unused-vars: "off" */
    const slideReset = function (speed, runCallbacks, internal) {
        if (speed === void 0) {
            speed = this.params.speed;
        }
        if (runCallbacks === void 0) {
    ...
    const slideToClickedSlide = function () {
        const swiper = this;
        const params = swiper.params;
        const $wrapperEl = swiper.$wrapperEl;
    ...
    const setGrabCursor = function (moving) {
        const swiper = this;
    ...
    const unsetGrabCursor = function () {
        const swiper = this;
    ...
    const prependSlide = function (slides) {
        const swiper = this;
        const params = swiper.params;
        const $wrapperEl = swiper.$wrapperEl;
        const activeIndex = swiper.activeIndex;
    ...
    const removeSlide = function (slidesIndexes) {
        const swiper = this;
        const params = swiper.params;
        const $wrapperEl = swiper.$wrapperEl;
        const activeIndex = swiper.activeIndex;
    ...
    const removeAllSlides = function () {
        const swiper = this;
  ...
  var android = ua.match(/(Android);?[\s\/]+([\d.]+)?/); // eslint-disable-line
      ...
      !device.webView &&
      (ipod || iphone) &&
      (Number(osVersionArr[0]) === 7 ? Number(osVersionArr[1]) >= 1 : Number(osVersionArr[0]) > 7) &&
    ...
    const getBreakpoint = function (breakpoints) {
    ...
    const breakpoints = {setBreakpoint, getBreakpoint};
    ...
    const loadImage = function (imageEl, src, srcset, sizes, checkForComplete, callback) {
        let image;
    ...
    const Swiper$1 = (function (SwiperClass$$1) {
        function Swiper() {
            let args = [], len = arguments.length;
        ...
        const staticAccessors = {extendedDefaults: {}, defaults: {}, Class: {}, $: {}};
    ...
    const Virtual = {
        update: function update(force) {
            ...
            const ref$1 = swiper.virtual;
            const previousFrom = ref$1.from;
            const previousTo = ref$1.to;
            const slides = ref$1.slides;
            const previousSlidesGrid = ref$1.slidesGrid;
            const renderSlide = ref$1.renderSlide;
            const previousOffset = ref$1.offset;
    ...
    const Scrollbar = {
        ...
        setDragPosition: function setDragPosition(e) {
            ...
            const $el = scrollbar.$el;
            const dragSize = scrollbar.dragSize;
            const moveDivider = scrollbar.moveDivider;
